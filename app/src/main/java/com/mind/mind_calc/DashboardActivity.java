...
import com.mind.mind_calc.Sounds.SoundEffect;
import com.mind.mind_calc.Sounds.Winner;
...
//    Tap to close app
    ...
    public void onBackPressed() {
        ...
        exitDialog.getWindow().getAttributes().windowAnimations = R.style.DialogSlider;
        exitDialog.show();
        ...
        btnExitYes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new SoundEffect().tap(DashboardActivity.this);
                finishAffinity();
                System.exit(0);
            }
        });
...
//    Method for show game play dialog box
    private void showGame(String mode)
    {
        ...
        gamePlayDialog.getWindow().getAttributes().windowAnimations = R.style.DialogSlider;
        gamePlayDialog.show();
        ...
        countDownTimer = new CountDownTimer(maxTime+1000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if ((millisUntilFinished / 1000) < 6) {
                    new SoundEffect().toneBeep(DashboardActivity.this);
...
//    Method for show show time out dialog box
                                      ...
                                      TextView textQuestion, String mode, Button btnSubmitAnswer)
    {
        ...
        timeOutDialog.getWindow().getAttributes().windowAnimations = R.style.DialogSlider;
        timeOutDialog.show();
        timeOutDialog.setCancelable(false);
        timeOutDialog.setCanceledOnTouchOutside(false);

        new SoundEffect().tone(DashboardActivity.this);
...
//    Method for show leader board
    ...
    {
        leaderBoardDialog.getWindow().getAttributes().windowAnimations = R.style.DialogSlider;
        leaderBoardDialog.show();
        leaderBoardDialog.setCancelable(false);
        leaderBoardDialog.setCanceledOnTouchOutside(false);

        new Winner().tone(DashboardActivity.this);
...
//    Method for get http response and validate answer
                                 ...
                                 TextView textQuestion, String mode, Button btnSubmitAnswer)
    {
        ...
        if (answer.isEmpty()) {
            ...
            loadingDialog.getWindow().getAttributes().windowAnimations = R.style.DialogSlider;
            loadingDialog.show();
...
//    Method for answer correct dialog box
                                         ...
                                         TextView textQuestion, TextView textTime, String mode, Button btnSubmitAnswer)
    {
        ...
        correctAnswerDialog.getWindow().getAttributes().windowAnimations = R.style.DialogSlider;
        correctAnswerDialog.show();
        correctAnswerDialog.setCancelable(false);
        correctAnswerDialog.setCanceledOnTouchOutside(false);

        new SoundEffect().tone(DashboardActivity.this, "correct");
...
//    Method for answer wrong dialog box
    private void showAnswerWrongDialog(String value, EditText textAnswer,
                                       TextView textQuestion, TextView textTime, String mode, Button btnSubmitAnswer)
    {
        wrongAnswerDialog.getWindow().getAttributes().windowAnimations = R.style.DialogSlider;
        wrongAnswerDialog.show();
        wrongAnswerDialog.setCancelable(false);
        wrongAnswerDialog.setCanceledOnTouchOutside(false);

        new SoundEffect().tone(DashboardActivity.this, "wrong");
