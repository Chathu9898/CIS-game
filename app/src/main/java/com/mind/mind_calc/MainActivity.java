...
//        Enter button command
        btnEnter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new SoundEffect().tap(MainActivity.this);
                enterToGame();
            }
        });
...
//    Method for show login dialog
    private void showLogin() {
        loginDialog.getWindow().getAttributes().windowAnimations = R.style.DialogSlider;
        loginDialog.show();
...
//    Method for show registration dialog
    private void showRegistration() {
        regDialog.getWindow().getAttributes().windowAnimations = R.style.DialogSlider;
        regDialog.show();
